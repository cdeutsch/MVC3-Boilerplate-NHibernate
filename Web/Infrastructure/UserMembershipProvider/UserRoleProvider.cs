...
namespace Web.Infrastructure.UserMembershipProvider
{
    public class UserRoleProvider : RoleProvider
    {
        ...
        public override bool DeleteRole(string roleName, bool throwOnPopulatedRole)
        {
            try
            {
                return _roleRepository.DeleteRole(roleName, throwOnPopulatedRole);
            }
        ...
        {
            return _roleRepository.FindUsersInRole(roleName, usernameToMatch).Select(uu => uu.Email).ToArray();   
        }
        ...
        {
            var qRoles = from rr in _session.Query<Role>()
                         select rr.RoleName;
        ...
        {
            return _roleRepository.GetRolesForUser(username).Select(rr => rr.RoleName).ToArray();
        }
        ...
        {
            return _roleRepository.FindUsersInRole(roleName).Select(uu => uu.Email).ToArray();
        }
        ...
        {
            _roleRepository.RemoveUsersFromRoles(usernames, roleNames);
            return;
        }
